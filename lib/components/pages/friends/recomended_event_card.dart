...
class RecomendedEventCard extends StatefulWidget {
  final Event event;
  const RecomendedEventCard(this.event) : super();

  @override
  _RecomendedEventCardState createState() => _RecomendedEventCardState();
}

class _RecomendedEventCardState extends State<RecomendedEventCard> {
  late String date;
